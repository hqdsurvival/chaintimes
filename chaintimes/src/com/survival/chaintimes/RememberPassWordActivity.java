...
public class RememberPassWordActivity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.tv_submit:
			...
			HttpRequest.Register(mobilephone, dbpassword, "", 1, new OnHttpResponseListener() {
