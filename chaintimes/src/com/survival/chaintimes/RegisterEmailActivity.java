...
public class RegisterEmailActivity extends BaseActivity implements OnClickListener {
	...
	public void initView() {
		...
		tv_check_mobile = (TextView) findViewById(R.id.tv_check_mobile);
	}
	...
	public void onClick(View v) {
		...
		case R.id.tv_send:
			if(StringUtils.isEmpty(email)){
				showShortToast(getResources().getString(R.string.register_email_isempty));
				return;
			}
			if(!StringUtil.isEmail(email)){
				showShortToast(getResources().getString(R.string.register_email_issuccess));
				return;
			}
			showProgressDialog(getResources().getString(R.string.dialog_progress));
			HttpRequest.SendEmail(email, 1,new OnHttpResponseListener() {
				...
				public void onHttpResponse(int requestCode, String resultJson, Exception e) {
					...
					showShortToast(getResources().getString(R.string.result_sendemail_success));
					Message message = new Message();
