...
public class RegisterMobileActivity extends BaseActivity implements OnClickListener {
	...
	public void initView() {
		...
		tv_check_email = (TextView) findViewById(R.id.tv_check_email);
	}
	...
	public void initEvent() {
		...
		tv_check_email.setOnClickListener(this);
	}
	@Override
	public void onClick(View v) {
		...
		case R.id.tv_send:
			...
			HttpRequest.SendSms(phone, Constant.Config.SendSmsEnum.register.toString(), 1,new OnHttpResponseListener() {
